...
const map = exports.map = (0, _util.curry)((fn, asyncIterable) => ({
...
const filter = exports.filter = (0, _util.curry)((fn, asyncIterable) => ({
	[Symbol.asyncIterator]: async function* () {
		let index = 0;
		for await (const i of asyncIterable) {
...
const take = exports.take = (0, _util.curry)((number, asyncIterable) => ({
	[Symbol.asyncIterator]: async function* () {
		let count = 1;
		for await (const i of asyncIterable) {
...
const skip = exports.skip = (0, _util.curry)((limit, asyncIterable) => ({
	[Symbol.asyncIterator]: async function* () {
		let count = 0;
		for await (const i of asyncIterable) {
			if (count < limit) {
...
const flatMap = exports.flatMap = (0, _util.curry)((fn, asyncIterable) => ({
	[Symbol.asyncIterator]: async function* () {
		for await (const i of asyncIterable) {
...
const concat = exports.concat = (...values) => ({
	[Symbol.asyncIterator]: async function* () {
