...
import {find, findIndex} from '../src/lib/operators';
...
export default test('find test suite', t => {
    ...
    t.test('find curried', async t => {
        ...
        const value = await greaterOrEqualTo3(counterGenerator(5));
    ...
    t.test('find curried with no result', async t => {
        ...
        const value = await greaterOrEqualToEvil(counterGenerator(5));
